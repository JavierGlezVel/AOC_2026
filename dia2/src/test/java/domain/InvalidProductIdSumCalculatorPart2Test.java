...
class InvalidProductIdSumCalculatorPart2Test {
    @Test
    void sumsInvalidIdsFromOfficialExampleWithNewRules() {
        ...
        long sum = new InvalidProductIdSumCalculatorPart2().calculate(ranges);
